//palavra: A palavra que estamos definindo.
//significado: Uma breve explicação do termo.
//utilizaçao: Onde e como o termo é utilizado.
//exemplos: Exemplos práticos do uso do termo.

let dados = [{
    palavra: "Scrum",
    significado: "Uma metodologia ágil de desenvolvimento de software, utilizada para gerenciar projetos complexos e adaptáveis.",
...
},
    {
      ...
      significado: "É um modelo de computação que permite o acesso sob demanda a um conjunto compartilhado de recursos computacionais configurados (redes, servidores, armazenamento, aplicativos e serviços) que podem ser rapidamente provisionados e liberados com pouco gerenciamento do provedor de serviços.",
      utilizacao: "Utilizado para armazenar dados na nuvem, executar aplicativos, hospedar sites e muito mais. É como alugar um computador poderoso e flexível, sem precisar comprar e manter um hardware próprio.",
      exemplos: "Exemplo: Utilizar um serviço de armazenamento em nuvem como o Google Drive para guardar seus arquivos e acessá-los de qualquer lugar com internet.",
      piada: "Joke: O que uma nuvem disse para a outra? Nada, nuvens não falam! Mas elas armazenam muitos dados!",
      linkInfo: "https://aws.amazon.com/pt/what-is-cloud-computing/",
      tags: ""
    },
    {
        palavra: "Big Data",
        significado: "Grandes volumes de dados estruturados e não estruturados que são muito complexos para serem gerenciados e processados por ferramentas de banco de dados tradicionais.",
      ...
      {
        palavra: "DevOps",
        significado: "Uma abordagem cultural e profissional que combina desenvolvimento de software (Dev) e operações de TI (Ops), com o objetivo de encurtar o ciclo de desenvolvimento e fornecer serviços de alta qualidade.",
      ...
      {
        palavra: "Internet das Coisas (IoT)",
        significado: "Uma rede de dispositivos físicos conectados à internet, que coletam e trocam dados.",
